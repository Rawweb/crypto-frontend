...
const AuthLayout = () => {
  return (
    <div className="min-h-screen bg-bg-main text-text-primary flex flex-col items-center justify-center px-4">
      {/* logo → home */}
      <Link to="/" className="mb-6 flex items-center gap-2 group mt-5">
        <img
          src={logo}
          alt="Crypto logo"
      ...
      {/* auth card */}
      <div className="w-full max-w-md bg-bg-surface border border-bg-elevated rounded-2xl p-6 sm:p-8 mb-5">
        <Outlet />
      </div>
    </div>
  );
