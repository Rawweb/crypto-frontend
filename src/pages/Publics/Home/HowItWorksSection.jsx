...
const STEP_VARIANTS = {
  home: {
    ...
    subtext: 'Get started in minutes. No complexity, no confusion.',
    steps: [
      {
        step: '01',
      ...
      },
      {
        ...
        description:
          'Deposit funds easily and get ready to trade or invest.',
      },
      {
        step: '03',
        title: 'Trade & grow',
        description:
          'Buy, sell, or invest in crypto with real-time tracking.',
      },
      {
        step: '04',
  ...
  buySell: {
    heading: 'How buying & selling works',
    subtext:
      'A simple, secure process for depositing and withdrawing funds.',
    steps: [
      {
        step: '01',
        title: 'Deposit funds',
        description:
          'Add funds securely to your wallet to buy or hold crypto.',
      },
      {
        step: '02',
        title: 'Balance updates',
        description:
          'Your wallet balance reflects once deposits are confirmed.',
      },
      {
        step: '03',
        title: 'Request withdrawal',
        description:
          'Submit a withdrawal request anytime from your wallet.',
      },
      {
        step: '04',
        title: 'Receive funds',
        description:
          'Withdrawals are processed after verification for security.',
      },
    ],
  },
};

const HowItWorksSection = ({ variant = 'home' }) => {
  const config = STEP_VARIANTS[variant];
