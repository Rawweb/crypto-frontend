        ...
        <div>
          ...
          <div className="space-y-5 text-text-secondary/70 md:text-lg">
            <p>
              ...
              than it needs to be. Confusing interfaces, unclear fees, and slow
              withdrawals create unnecessary friction.
            </p>
            ...
            <p>
              The goal is simple: give users full visibility and control without
              the noise.
            </p>
          </div>
        </div>
