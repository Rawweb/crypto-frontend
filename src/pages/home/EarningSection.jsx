...
const EarningsSection = () => {
  return (
    <section className="container mt-32 flex flex-col md:flex-row gap-8 md:gap-10 lg:gap-20 items-center">
      {/* left: visual */}
      ...
      <div className="w-full md:w-1/2 space-y-6 max-w-xl text-center md:text-left">
        ...
        <p className="text-text-secondary/70 md:text-lg ">
          Monitor your earnings with clean visuals and real-time insights. Stay
          informed, spot trends early, and make smarter financial decisions with
          ease.
        </p>
      </div>
    </section>
